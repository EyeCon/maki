...
- Generated pages (tools, providers, configuration, lua-api, plugins, keybindings, commands, folder-trust) come from `maki-docgen`: edit the source, run `make gen-docs`, never edit output by hand.
