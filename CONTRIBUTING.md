...
Useful commands are in the `Makefile`, most useful probably is `make ci` that runs locally basically everything we run in the CI automatically to block PRs.
